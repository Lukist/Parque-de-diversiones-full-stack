...
public class crearHorario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        long atraccionId = Long.parseLong(request.getParameter("Atraccion"));
        Atraccion atraccion = controladora.encontrarAtraccion(atraccionId);
        
        controladora.crearHorario(horaFin, horaPrincipio, atraccion);
